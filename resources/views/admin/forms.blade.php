                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="my-3 mb-3 add">ADD A CHOCOLATE</h3>
                                        <form action="{{ route('admin.store') }}"  method="POST" enctype="multipart/form-data" class="d-flex flex-column mx-auto">
                                            @csrf
                                            {{-- product name --}}
                                            ...
                                            {{-- ingredients --}}
                                            <div class="form-group">
                                                <textarea class="form-control" name='ingredients' rows="5" placeholder="Ingredients...">{{ old('ingredients') }}</textarea>
                                            ...
                                            {{-- nutrition values --}}
                                            <div class="form-group">
                                                <textarea class="form-control" name='nutritionValues' rows="5" placeholder="Nutrition values...">{{ old('nutritionValues') }}</textarea>
                                            ...
                                            {{-- previous price --}}
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="previousPrice" placeholder="Previous price..." value="{{ old('previousPrice') }}"/>
                                            ...
                                            {{-- current price --}}
                                            <div class="form-group">
                                                <input type="text" class="form-control" name='currentPrice' placeholder="Current price..." value="{{ old('currentPrice') }}"/>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="availability" id="flexRadioDefault1" value="1" @if(old('availability')) checked @endif>
                                                <label class="form-check-label" for="flexRadioDefault1">
                                                    Available
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="availability" id="flexRadioDefault2" value="0" @if(!old('availability')) checked @endif>
                                            ...
                                            @endif
                                            <div>
                                                <input type="submit" value="Add" class="mt-3 btn btn-primary px-4 py-2" />
                                            </div>
                                        </form>
